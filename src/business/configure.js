...
export async function getSectionClass(args) {
    ...
    let lesson = { "07:00": 1, "07:50": 1, "07:55": 2, "08:45": 2, "08:50": 3, "09:40": 3, "09:45": 4, "10:35": 4, "10:40": 5, "11:30": 5, "11:35": 6, "12:25": 6, "12:55": 7, "13:45": 7, "13:50": 8, "14:40": 8, "14:45": 9, "15:35": 9, "15:40": 10, "16:30": 10, "16:35": 11, "17:25": 11, "17:30": 12 };
...
export async function getStudy(args) {
    let { pageSize, pageIndex, search } = args;
    let sql_select = `SELECT sd.id_student, sd.id_section_class, st.student_name, st.student_code, sb.subject_name, sc.section_class_name, y.year_name, smt.semester_name
                        FROM student st
